...
for k in DMU:
    ...
    slack_p1[k] = "The inefficiency of process 1 of DMU %s:%4.4g" % (
        k,
        process1_slack[k],
    )
    process2_slack = m.getAttr("slack", P2)
    slack_p2[k] = "The inefficiency of process 2 of DMU %s:%4.4g" % (
        k,
        process2_slack[k],
    )
    process3_slack = m.getAttr("slack", P3)
    slack_p3[k] = "The inefficiency of process 3 of DMU %s:%4.4g" % (
        k,
        process3_slack[k],
    )
